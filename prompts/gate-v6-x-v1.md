...
- Market / business model / go-to-market: "SaaS", "B2B", "B2C", "marketplace", "e-commerce", "PLG" name the EMPLOYER's business model or the market it sells into — not a competency the candidate carries; "team management", "people management", "cross-functional" name a generic managerial scope, not a matchable skill. NEVER emit any of them as a KEYWORD → NO filter. (An account executive is one whether the product is sold SaaS or B2B; a marketing director manages a team by definition.)
