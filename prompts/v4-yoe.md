...
- DURATION_IN_JOB — a closed integer range "min-max" in whole years, using the SAME rule as YEARS_OF_EXPERIENCE above ("at least N" → "N-100", never "N+"; "up to N" → "0-N"; omit if no number stated).
