...
- COMPANY_INDUSTRY — the EMPLOYER's sector, expressed as a value from the CLASSIC/legacy LinkedIn industry taxonomy (the standard ~150 industries that predate LinkedIn's 2022 expansion — NOT the newer, more granular taxonomy). Emit the exact canonical value in lowercase, using "&" (not "and") where the classic form does. CRITICAL — use the CLASSIC form, never the newer one: "computer software" (NOT "software development"), "sports" (NOT "spectator sports"), "entertainment" (NOT "entertainment providers"), "renewables & environment" (NOT "renewable energy ..."), "individual & family services" (NOT "elderly/disability care ..."), "construction" (NOT "building construction"). Other canonical examples: "financial services", "banking", "hospital & health care", "marketing and advertising", "management consulting", "staffing and recruiting", "real estate", "hospitality", "information technology and services". If no classic-taxonomy value fits the employer's sector, emit NO COMPANY_INDUSTRY rather than an invented, newer-taxonomy, or near-miss value (it would match zero profiles)
